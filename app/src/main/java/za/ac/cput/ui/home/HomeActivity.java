...
////import za.ac.cput.R;
////import za.ac.cput.adapters.CategoryAdapter;
...
//                    Log.d(TAG, "API Success! Loaded " + loadedCategories.size() + " categories");
//
//                    // Set RecyclerView adapter with loaded categories
//                    CategoryAdapter adapter = new CategoryAdapter(loadedCategories, HomeActivity.this);
...
//    protected void onResume() {
//        super.onResume();
//        // Optional: log backend categories for debugging
//        if (loadedCategories != null) {
//            Log.d(TAG, "=== BACKEND CATEGORIES AVAILABLE ===");
//            for (Category cat : loadedCategories) {
//                Log.d(TAG, cat.getCategoryId() + ": " + cat.getName());
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        // Optional: debug backend categories
        if (loadedCategories != null) {
            Log.d(TAG, "=== BACKEND CATEGORIES AVAILABLE ===");
            for (Category cat : loadedCategories) {
                Log.d(TAG, cat.getCategoryId() + ": " + cat.getName());
